...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Uy86pEsfNS)
...
```sh
npx nx serve ctx-dashboard
```

To create a production bundle:

```sh
npx nx build ctx-dashboard
```

To see all available targets to run for a project, run:

```sh
npx nx show project ctx-dashboard
```
